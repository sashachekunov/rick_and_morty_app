...
void main() {
  test('CharacterRepositoryImpl getCharacterById test', () async {
    // Arrange
    final client = MockClient();
    when(client.get(Uri.parse('https://rickandmortyapi.com/api/character/1'),
        headers: {
    ...
    // Act
    var res = await characterRepositoryImpl.getCharacterById(1);
  ...
  test('CharacterRepositoryImpl getCharacterById ServerError test', () async {
    // Arrange
    final client = MockClient();
    when(client.get(Uri.parse('https://rickandmortyapi.com/api/character/1000'),
        headers: {
          'Content-Type': 'application/json',
    ...
    // Act
    var res = await characterRepositoryImpl.getCharacterById(1000);

    // Assert
    expect(res.fold((l) => l, (r) => r), ServerError());
  });

  test('CharacterRepositoryImpl getAllCharacters test', () async {
    // Arrange
    final client = MockClient();
    when(client
      ...
      'Content-Type': 'application/json',
        ...
        '{"info":{"count":826,"pages":42,"next":"https://rickandmortyapi.com/api/character/?page=2","prev":null}, "results": [1, 2, 3]}',
        200));
    when(client.get(
        Uri.parse(
    ...
    // Act
    var res = await characterRepositoryImpl.getAllCharacters();
  ...
  test('CharacterRepositoryImpl getAllCharacters ServerError test', () async {
    // Arrange
    final client = MockClient();
    when(client
        .get(Uri.parse('https://rickandmortyapi.com/api/character/'), headers: {
  ...
  test('CharacterRepositoryImpl getCharactersByPage ServerError test',
      () async {
    // Arrange
    final client = MockClient();
    when(client.get(
