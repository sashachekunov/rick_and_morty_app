...
void main() {
  test('CharacterDataSource get all characters test', () async {
    // Arrange
    ...
    // Act
    var characterRemoteDataSource = CharacterRemoteDataSourceImpl(
      client: client,
    );
    var characters = await characterRemoteDataSource.getAllCharacters();
  ...
  test('CharacterDataSource get single character test', () async {
    // Arrange
    final client = MockClient();
    ...
    var character = await characterRemoteDataSource.getCharacterById(1);
  ...
  test('CharacterDataSource get characters by page test', () async {
    // Arrange
    final client = MockClient();
    when(client.get(
    ...
    var characters = await characterRemoteDataSource.getCharactersByPage(1);
